...
jQuery(document).ready(function () {
    ...
    }).navGrid('#equipgridp', { deltext: "Delete", searchtext: "Find", refreshtext: "Reload", edit: false, add: false, del: false, search: true, refresh: true }, //options
         {}, // edit options
         {}, // add options
         {}, // del options
    ...
    }).navGrid('#equipsvcp', { edit: false, add: false, del: false, search: false, refresh: false }, //options
         {}, // edit options
         {}, // add options
    ...
    }).navGrid('#equipasgnp', { edit: false, add: false, del: false, search: false, refresh: false }, //options
         {}, // edit options
         {}, // add options
         {}, // del options
         {}, // search options
    ...
    jQuery("#toolgrid").jqGrid({
        ...
        colModel: [
  		        ...
  		        { name: 'tools_type_descr', index: 'tools_type_descr', width: 100, editable: true, search: true, stype: "select", searchoptions: { sopt: ['eq'], dataUrl: '/EquipTrack/GetToolTypesSearch'} },
   		        { name: 'tools_descr_descr', index: 'tools_descr_descr', width: 80, editable: true, search: true, stype: "select", searchoptions: { sopt: ['eq'], dataUrl: '/EquipTrack/GetToolDescsSearch'} },
   		        { name: 'tool_mfg_descr', index: 'tool_mfg_descr', width: 90, editable: true, search: true, stype: "select", searchoptions: { sopt: ['eq'], dataUrl: '/EquipTrack/GetToolMfgsSearch'} },
   		        { name: 'size_descr', index: 'size_descr', width: 60, editable: true, search: true, stype: "select", searchoptions: { sopt: ['eq'], dataUrl: '/EquipTrack/GetToolSizesSearch'} },
   		        { name: 'work_loc', index: 'work_loc', width: 80, editable: true, edittype: "select", editoptions: { dataUrl: '/EquipTrack/GetLocations' }, search: true, stype: "select", searchoptions: { sopt: ['eq'], dataUrl: '/EquipTrack/GetLocations'} },
   		        { name: 'registered_by', index: 'registered_by', width: 80, editable: true, search: false },
   		        { name: 'managed_by', index: 'managed_by', width: 80, editable: true, edittype: "select", editoptions: { dataUrl: '/EquipTrack/GetDivisions' }, search: false },
    ...
    }).navGrid('#toolsvcp', { edit: false, add: false, del: false, search: false, refresh: false }, //options
         {}, // edit options
         {}, // add options
         {}, // del options
         {}, // search options
    ...
    }).navGrid('#toolasgnp', { edit: false, add: false, del: false, search: false, refresh: false }, //options
         {}, // edit options
         {}, // add options
         {}, // del options
         {}, // search options
    ...
    $('#equip_edit_form').ajaxForm(function (data) {
        ...
        if (respArray[0] == "Success") {
            ...
            if (chkEquipSold == "True" || chkEquipStolen == "True" || chkEquipInRepair == "True" || chkEquipTotaled == "True" || chkEquipUnknown == "True") {
    ...
    $('#tool_edit_form').ajaxForm(function (data) {
        ...
        if (respArray[0] == "Success") {
            ...
            if (chkToolSold == "True" || chkToolStolen == "True" || chkToolInRepair == "True" || chkToolTotaled == "True" || chkToolUnknown == "True") {
...
function OpenEquipEditDlg(dta) {
    ...
    if (oper == "Edit") {
        ...
        $("#txtEquipID").attr("disabled", "disabled");
        $('#txtEquipYear').attr("disabled", "disabled");
        $('#txtEquipVIN').attr("disabled", "disabled");
        $('#txtEquipTitleNum').attr("disabled", "disabled");
        $('#txtEquipTagNum').attr("disabled", "disabled");
        $('#txtEquipGVW').attr("disabled", "disabled");
        $('#txtEquipGCW').attr("disabled", "disabled");
        $('#txtEquipUnlaidenWt').attr("disabled", "disabled");
        $('#ddlTagSt').attr("disabled", "disabled");
        $('#ddlFuel').attr("disabled", "disabled");
        $('#txtCost').attr("disabled", "disabled");
        $('#txtCurrentValue').attr("disabled", "disabled");
        $('#chkEquipSold').attr("disabled", "disabled");
        $('#chkEquipToBeSold').attr("disabled", "disabled");
        ...
        $('#chkIFTASticker').attr("disabled", "disabled");
        $('#chkEquipGPS').attr("disabled", "disabled");
        $('#chkEquipEZPASS').attr("disabled", "disabled");
        $('#chkEquipFuelCard').attr("disabled", "disabled");
    ...
    $('#dtEquipInspDue').val('');
    $('#dtEquipInspDue').datepicker('disable');
    $('#dtEquipInspDue').val(dta.insp_due_dt);

    $('#dtEquipMngByDt').val('');
    $('#dtEquipMngByDt').datepicker('disable');
    $('#dtEquipMngByDt').val(dta.managed_by_dt);
    ...
    $.get("/EquipTrack/GetEquipEditDlg/", {}, function (data) {
        ...
        if (oper == "Edit") {
            ...
            $('#ddlEquipMake').attr("disabled", "disabled");
...
function OpenToolEditDlg(dta) {
    ...
    if (oper == "Edit") {
        ...
        $("#txtToolModelNum").attr("disabled", "disabled");
        $("#txtToolSerialNum").attr("disabled", "disabled");
        $("#txtToolYearPur").attr("disabled", "disabled");
        $("#txtToolCost").attr("disabled", "disabled");
        $("#chkToolSold").attr("disabled", "disabled");
        $("#chkToolToBeSold").attr("disabled", "disabled");
    ...
    $.get("/EquipTrack/GetToolEditDlg/", {}, function (data) {
        ...
        if (oper == "Edit") {
            ...
            $("#ddlToolDesc").attr("disabled", "disabled");
            $("#ddlToolMfg").attr("disabled", "disabled");
...
function OpenSmallToolEditDlg(dta) {
    ...
    $("#smalltool_dlg_success").html("Save Succesful!");
