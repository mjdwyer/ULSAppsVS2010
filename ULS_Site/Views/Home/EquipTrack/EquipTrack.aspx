...
.center {
   ...
   { %>
    <script type="text/javascript" src="/Scripts/EquipTracker.js?86"></script> 
    <%}%>
   ...
   { %>
    ...
    <%}%>
   <%else { %>
    <script type="text/javascript" src="/Scripts/EquipTrackerRO.js?81"></script>
   <% }%>
    <script type="text/javascript" src="/Scripts/EquipTrackerFuncs.js?52"></script>
...
-->        
    ...
    <div id="tool_svc_edit_dlg" title=""  class="dlg">
        ...
        <tr>
        <td colspan="2">
        <a href="" id="svc_order_link" target="_blank" style="color:Blue;padding-top:10px">View Service Order</a>
...
<!--        <input type="text" id="txtTagSt" name="txtTagSt" autocomplete="off" /> -->
    ...
    <div id="img_dialog" title="Images for ">
        ...
        <p><input type="file" id="fileUpload" name="fileUpload" size="23" value="Select Image" onchange="CheckImgForm()" style="border: solid 1px red"/> </p>
    ...
    <div id="svc_attachment_dialog" title="Images for ">
        ...
        <input type="hidden"  id="hdnSvcIDAttach" name="hdnSvcIDAttach" value=""/>
        <input type="hidden"  id="hdnAttachType" name="hdnAttachType" value=""/>
        <center><img id="attach_loading" src="/Content/images/ajax-loader.gif" alt=""/></center>
        <div id="attach_success" style="color:green; padding-left:240px"></div>
        </form>         
    </div>
